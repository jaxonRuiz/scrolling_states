class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.cameras.main.startFollow(this.hero, false, 0.5, 0.5); // may want to try toggling bool
        this.physics.world.setBounds(0, 0, this.map.width, this.map.height); // setting physics worlds bounds to match map
        // physics
        ...
        // playing animation at start for testing
        //this.hero.anims.play("swing-360");
    }
